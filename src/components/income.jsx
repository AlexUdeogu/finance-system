  ...
  return (
    <div>
      <div className='container mx-auto px-4 sm:px-6 py-4'>
        <h1 className="text-4xl sm:text-6xl font-bold text-gray-800">Income</h1>
        <p className="text-gray-600 mt-2 text-base sm:text-xl">
          Manage your income and track your financial inflow.
        </p>
      </div>

      <div className="flex flex-col lg:flex-row justify-center m-2 items-stretch">
        <div className="bg-gray-100 container mx-auto rounded-md p-6 sm:p-10 flex flex-col lg:flex-row">
          ...
          <div className="flex flex-col justify-start w-full lg:w-1/2 lg:pr-5 mb-6 lg:mb-0">
            <div className='bg-green-200 mb-5 p-4 sm:p-5 rounded-md w-full'>
              <h1 className='font-semibold text-gray-800 text-xl sm:text-2xl'>Income</h1>
              <p className='font-medium text-green-500 text-3xl sm:text-5xl'>₦{totalIncome.toLocaleString()}</p>
            </div>

            {/* Line Chart */}
            <div className="bg-white p-4 sm:p-5 w-full rounded-xl mb-5">
              <h2 className="text-xl sm:text-2xl text-gray-800 font-semibold">Income Over Time Chart</h2>
          ...
          <div className="flex flex-col justify-center w-full lg:w-1/2 sm:mt-5 lg:mt-0 lg:pl-5">
            <div className="bg-white p-4 sm:p-5 rounded-md">
              <h2 className="text-xl sm:text-2xl text-gray-800 font-semibold">Record your income</h2>
              <p className='text-gray-800 text-sm sm:text-base mb-5'>
                Easily log your income to maintain a clear financial overview.
              </p>
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  <label htmlFor="title" className="block text-gray-800 text-sm sm:text-base mb-2">Income Title</label>
                  <input
                    type="text"
                    id="title"
                    value={title}
                ...
                <div>
                  <label htmlFor="amount" className="block text-gray-800 text-sm sm:text-base mb-2">Income Amount</label>
                  <input
                    type="number"
                    id="amount"
                    value={amount}
                ...
                <div>
                  <label htmlFor="date" className="block text-gray-800 text-sm sm:text-base mb-2">Date</label>
                  <input
                    type="date"
                    id="date"
                    value={selectedDate}
                ...
                <div>
                  <label htmlFor="category" className="block text-gray-800 text-sm sm:text-base mb-2">Select Category</label>
                  <select
                    id="category"
                ...
                <div>
                  <label htmlFor="description" className="block text-gray-800 text-sm sm:text-base mb-2">Description</label>
                  <textarea
                    id="description"
                    value={description}
